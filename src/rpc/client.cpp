...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "protestnote", 0, "id" },
    { "protestnote", 1, "fee" },
    { "dischargedemands", 0, "id" },
    { "dischargedemands", 1, "fee" },
    { "claimnote", 0, "id" },
    { "claimnote", 1, "units" },
    { "claimnote", 2, "fee" },
    ...
    { "swapnote", 3, "minout" },
    { "swapnote", 4, "fee" },
    { "proposesettle", 0, "ownid" },
    { "proposesettle", 1, "counterparty" },
    { "proposesettle", 2, "maxunits" },
    { "proposesettle", 3, "expiryblocks" },
    { "proposesettle", 4, "fee" },
    { "signsettle", 1, "fee" },
    { "proposediscount", 0, "id" },
    { "proposediscount", 1, "houseid" },
    { "proposediscount", 2, "price" },
    { "proposediscount", 3, "expiryblocks" },
    { "signdiscount", 1, "fee" },
    { "recoursebill", 0, "id" },
    { "recoursebill", 1, "fee" },
    { "listpresentable", 0, "id" },
    { "getpool", 0, "id" },
