...
pub fn tests(
    ...
    vec![
        ...
        // FreeBank (operator decision 2026-09-15): the `vote` gate exercised
        // BitAsset issue/transfer/sign, which are disabled at validation on
        // this chain, so it is removed. The remaining three gates prove the
        // two-way peg only (deposit → BMM → withdrawal, IBD, unknown
